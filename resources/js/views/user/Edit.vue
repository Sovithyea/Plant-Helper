    ...
    <v-container fluid>
        <v-card class="mb-3">
            ...
            <template v-else>
                ...
                <v-card-subtitle>Fill the below form to edit the user..</v-card-subtitle>
            </template>
        </v-card>
...
export default {
    ...
    methods:
    {
        fetchData()
        {
            axiosApiInstance.get(`user/${ this.$route.params.user }/edit`)
            .then(response => {
        ...
        onSubmit()
        {
            if (this.$refs.form.validate())
            {
                ...
                axiosApiInstance.post(`user/${ this.$route.params.user }`, formData, {
