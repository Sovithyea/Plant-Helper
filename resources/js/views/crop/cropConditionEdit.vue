    ...
    methods: {
        ...
        onSubmit() {
            if (this.$refs.form.validate()) {
                ...
                formData.append("crop_id", this.form.crop_id);
                formData.append("condition_id", this.form.condition_id);
                formData.append("min", this.form.min);
                formData.append("max", this.form.max);
                formData.append("regular", this.form.regular);
                axiosApiInstance
                    .post(`crop/${ this.$route.params.crop }/condition/${ this.$route.params.condition }/update`, formData, {
        ...
        async fetchConditionById () {
            axiosApiInstance.get(`crop/${ this.$route.params.crop }/condition/${ this.$route.params.condition }/edit`)
            .then(response => {
                // console.log(response);
                this.form = response.data[0],
                this.crops = response.data[1],
                this.conditions = response.data[2]
