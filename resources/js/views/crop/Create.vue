    ...
    <v-container fluid>
        <v-card class="mb-3">
            ...
            <template v-else>
                ...
                <v-card-subtitle
                    >Fill the below form to create new crop.</v-card-subtitle
                >
            </template>
        </v-card>
        <v-form
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-row>
                        ...
                        <v-col class="py-0" cols="12">
                            <text-editor  v-model="form.data.detail" :label="'Crop detail'"></text-editor>
                        </v-col>
                    </v-row>
                </v-card-text>
...
export default {
  components: { TextEditor },
    ...
    methods: {
        ...
        onSubmit() {
            if (this.$refs.form.validate()) {
                ...
                if (this.form.data.avatar)
                    ...
                    if(this.form.data.detail)
                    formData.append("detail",this.form.data.detail)
        ...
        async fetchCategory()
        {
            axiosApiInstance.get('/crop/create')
            .then(response => {
