    ...
    <v-container fluid>
        <v-card class="mb-3">
            ...
            <template v-else>
                ...
                <v-card-subtitle>Fill the below form to edit the condition...</v-card-subtitle>
            </template>
        </v-card>
...
export default {
    ...
    methods:
    {
        fetchData()
        {
            axiosApiInstance.get(`condition/${ this.$route.params.condition }/edit`)
            .then(response => {
        ...
        onSubmit()
        {
            if (this.$refs.form.validate())
            {
                ...
                axiosApiInstance.post(`condition/${ this.$route.params.condition }`, formData, {
